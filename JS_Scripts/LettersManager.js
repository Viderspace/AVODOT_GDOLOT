...
let secondLineY = firstLineY + 115 *(1.3/1.2);
...
let thirdLineY = secondLineY+ 350 *(1.3/1.2);
...
let fourthLineY = thirdLineY + 125 *(1.3/1.2);
let fourthLineX = 135*(1.3/1.2);
    ...
    AddLine(line) {
     ...
     spawnLines1And2() {
         ...
         this.line1 = [
             ...
             new Letter(466, 478, "Assets/עבודות_גדולות_אותיות/נק1.png", 0, -190*(1.3/1.2), false), // const נק1 = { width: 466, height: 478 };
             ...
             new Letter(466, 478, "Assets/עבודות_גדולות_אותיות/נק2.png", 0, -190*(1.3/1.2), false), // const נק2 = { width: 466, height: 478 };
             new Letter(1104, 1482, "Assets/עבודות_גדולות_אותיות/ת2.png", 160,0,true), // const ת1 = { width: 1104, height: 1482 };
         ];
         ...
         this.line2 = [
             ...
             new Letter(478, 490, "Assets/עבודות_גדולות_אותיות/נק-ירוק1.png", 0, -185*(1.3/1.2), false), // const נק-ירוק1 = { width: 478, height: 490 };
             ...
             new Letter(482, 490, "Assets/עבודות_גדולות_אותיות/נק-ירוק2.png", 0, -190*(1.3/1.2), false), // const נק-ירוק2 = { width: 482, height: 490 };
             new Letter(1235, 1438, "Assets/עבודות_גדולות_אותיות/ת1.png", 165,0,true), // const ת2 = { width: 1235, height: 1438 };
     ...
     spawnLines3And4(){
         ...
         this.line3 = [
             ...
             new Letter(493, 1452, "Assets/קול_קורא_אותיות/שחור_ו1.png", 210, -60*(1.3/1.2),true), // const שחור_ו1 = { width: 493, height: 1452 };
             new Letter(447, 447, "Assets/קול_קורא_אותיות/נק5.png", 0, -270*(1.3/1.2), false), // const נק5 = { width: 447, height: 447 };
             new Letter(1223, 1817, "Assets/קול_קורא_אותיות/שחור_ל.png", 185, -95*(1.3/1.2),true), // const שחור_ל = { width: 1223, height: 1817 };
         ];
         ...
         this.line4 = [
             ...
             new Letter(390, 1441, "Assets/קול_קורא_אותיות/שחור_ו2.png", 180, -60*(1.3/1.2), true), // const שחור_ו2 = { width: 390, height: 1441 };
             new Letter(447, 436, "Assets/קול_קורא_אותיות/נק_אדום.png", 0, -260*(1.3/1.2), false), // const נק_אדום = { width: 447, height: 436 };
             new Letter(1053, 1462, "Assets/קול_קורא_אותיות/שחור_ר.png", 160, -60*(1.3/1.2), true), // const שחור_ר = { width: 1053, height: 1462 };
             new Letter(1350, 1453, "Assets/קול_קורא_אותיות/שחור_א.png", 230, -60*(1.3/1.2), true), // const שחור_א = { width: 1350, height: 1453 };
