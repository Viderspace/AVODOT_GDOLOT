...
//
// const matterContainer = document.getElementById("kol_kore");
// const THICCNESS = 60;
//
//
...
//
// function BuildLines() {
//     while(i < thirdLine.length + fourthLine.length) {
//  if (i <  thirdLine.length) {
//             makeLetter(thirdLine[i], thirdLineOffset);
//             console.log("third line offset is " + thirdLineOffset.x + " " + thirdLineOffset.y);
//         } else if (i < thirdLine.length + fourthLine.length) {
//             makeLetter(fourthLine[i - thirdLine.length], fourthLineOffset);
